...
public class Stepdefinition {
    ...
    public void customer_enters_their_login_credentials_and(String username, String password) throws Throwable {
        Actions.Login(username,password);

    }

    @And("^swagLabs home page must load successfully$")
    public void swaglabs_home_page_must_load_successfully() throws Throwable {
